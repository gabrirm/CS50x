...
def buy():
    ...
    if request.method == "GET":
        ...
        updated_value = user_cash - transaction_value
        db.execute("UPDATE users SET cash = ? WHERE id = ?", updated_value, user_id)
...
def register():
    if request.method == "GET":
        ...
        if not username or not password or not confirmation:
            return apology("sorry, check your credentials")
        elif password != confirmation:
            return apology("sorry, invalid password confirmation")
        else:
